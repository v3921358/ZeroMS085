...
public class PlayerStats implements Serializable {
    ...
    private transient byte passive_mastery, passive_sharpeye_rate;//武器熟练度 爆击概率
    ...
    public final static short maxStr = 32767;
...
//            lock.unlock();
        ...
        for (IItem item : chra.getInventory(MapleInventoryType.EQUIPPED)) {
            ...
            if (equip.getState() > 1) {
                ...
                for (int i : potentials) {
                    if (i > 0) {
                        pot = ii.getPotentialInfo(i).get(ii.getReqLevel(equip.getItemId()) / 11);
                        if (pot != null) {
                            localstr += pot.incSTR;
                            localdex += pot.incDEX;
        ...
        for (IItem item : chra.getInventory(MapleInventoryType.CASH)) {
            ...
            if (dropMod == 1) {
                if (item.getItemId() == 5360014 || item.getItemId() == 5360015 || item.getItemId() == 5360016 || item.getItemId() == 5360000) {
                    dropMod = 2;
    ...
    public final float getHealHP() {
        ...
        return shouldHealHP + this.shouldHealHP;
    }
    ...
    public final float getHealMP() {
        ...
        return shouldHealMP + this.shouldHealMP;
    }
