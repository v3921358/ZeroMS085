...
public class SkilledCommand {
    ...
    public static class 黑名单 extends FakeReport {

        @Override
        public String getMessage() {
            return new StringBuilder().append("!黑名单 <玩家名称> - 将玩家设定为无法回报的黑名单").toString();
        }
    }
    ...
    public static class 满血 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!满血 - 补满血魔").toString();
        }
    }
    ...
    public static class 复活 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!复活  - 复活地图上所有的人").toString();
        }
    }
}
