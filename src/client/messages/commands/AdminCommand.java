...
public class AdminCommand {
    ...
    public static class 人气 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!人气 <角色名称> <名声> ...  - 名声").toString();
        }
    }
    ...
    public static class 选择活动 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!选择活动 - 打椰子，打瓶盖，爬绳子，终极忍苦，快速0X猜题，滚雪球，寻宝").toString();
        }
    }
    ...
    public static class 给所有人金币 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!给所有人金币 <数量> - 给所有玩家枫币").toString();
        }
    }
    ...
    public static class MakePNPC extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!克 <playername> <npcid> - 创造玩家NPC").toString();
        }
    }
    ...
    public static class 删除永久NPC extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!删除永久NPC [objectid] - 删除PNPC").toString();
        }

    }

    public static class 召唤怪物2 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!召唤怪物2 <怪物ID> <hp|exp|php||pexp = ?> - 召唤怪物").toString();
        }
    }

    public static class 所有玩家传送 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!所有玩家传送 <maipid> 把所有玩家传送到某个地图").toString();
        }
    }
    ...
    public static class 拉全部 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!拉全部 把所有玩家传送到这裡").toString();
        }
    }
    ...
    public static class 重置地图 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!重置地图 <maipid> - 重置某个地图").toString();
        }
    }
...
//                    c.getPlayer().getMap().broadcastMessage(MaplePacketCreator.spawnNPC(npc, true));
    ...
    public static class 满钱 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!满钱 - 枫币满").toString();
        }
    }
    ...
    public static class mesos extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!mesos <需要的数量> - 得到枫币").toString();
        }
    }
    ...
    public static class 制造装备 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!制造装备 <物品代码> (<力量> <敏捷> <智力> <幸运> <HP> <MP> <物攻> <魔攻> <物防> <魔防> <武器+x> <命中> <迴避> <移动> <跳跃> <衝捲数> <天数>)").toString();
        }
    }
    ...
    public static class 给地图人红利 extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String splitted[]) {
            if (splitted.length > 1) {
                ...
                final MapleMap froma = c.getPlayer().getMap();
                for (MapleCharacter chrrr : froma.getCharactersThreadsafe()) {
                    chrrr.startMapEffect("管理员 发放" + quantity + "活动积分给地图的所有玩家！祝您玩得开心快乐", 5120009);
                }
    ...
    public static class 重载转蛋机 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!重载转蛋机 - 重新载入转蛋机").toString();
        }
    }
