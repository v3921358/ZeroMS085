...
public class GMCommand {
    ...
    public static class 坐标 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!坐标 - 我的位置").toString();
        }
    }
    ...
    public static class 清除所有状态 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!清除所有状态 - 取消所有BUFF").toString();
        }
    }
    ...
    public static class 当前地图npc extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!当前地图npc - 查看所有NPC").toString();
        }
    }

    public static class 当前地图箱子反应堆 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!当前地图箱子反应堆 - 查看所有反应堆").toString();
        }
    }

    public static class 当前地图传送反应堆 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!当前地图传送反应堆 - 查看所有反应堆").toString();
        }
    }
    ...
    public static class map extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String splitted[]) {
            if (splitted.length < 2) {
                c.getPlayer().dropMessage(6, "使用方法: !map <地图名称>");
                ...
                c.getPlayer().dropMessage(6, "使用 !map <目的地>. 目的地地图如下:");
                StringBuilder sb = new StringBuilder();
                ...
                c.getPlayer().dropMessage(6, "错误的指令规则 - 使用 !map <目的地>. 来看目的地地图清单, 接著使用 !goto 目的地地图名称.");
            }
            return true;
        }
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!map <名称> - 到某个地图").toString();
    ...
    public static class 清除地板 extends RemoveDrops {
    ...
    public static class RemoveDrops extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!清除地板 - 移除地上的物品").toString();
...
//            }
    ...
    public static class 重载地图反应堆 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!重载地图反应堆 - 重置此地图所有的Reactor").toString();
    ...
    public static class 任务完成 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!任务完成 <任务ID> - 完成任务").toString();
    ...
    public static class 清除玩家物品 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!清除玩家物品 <角色名称> <物品ID> - 移除玩家身上的道具").toString();
        }
    }
    ...
    public static class 黑龙重置 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!黑龙重置 <频道> - 重製龙王地图").toString();
        }
    }
    ...
    public static class 杀地图怪物 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!杀地图怪物 <mobid> - 杀掉地图上某个怪物").toString();
    ...
    public static class 刷新地图 extends CommandExecute {
        ...
        public String getMessage() {
            return new StringBuilder().append("!刷新地图 <mapid> - 刷新某个地图").toString();
        }
    }
    ...
    public static class 开启pk extends CommandExecute {
        ...
        public String getMessage() {
            return new StringBuilder().append("!开启pk  - pvp开关").toString();
        }
    }
}
