...
public class PracticerCommand {
    ...
    public static class 跟踪 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!跟踪 [玩家名称] <地图ID> - 移动到某个地图或某个玩家所在的地方").toString();
        }
    }
    ...
    public static class 封号 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!封号 <玩家> <原因> - 封锁玩家").toString();
        }
    }
    ...
    public static class 拉 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!拉 把玩家传送到这裡").toString();
        }
    }
 ...
 /*public static class fixac extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String[] splitted) {
            ...
            try (Connection con = DatabaseConnection.getConnection(); PreparedStatement ps = con.prepareStatement("SELECT accountid FROM characters WHERE name = ?")) {
            ...
            try (Connection con = DatabaseConnection.getConnection(); PreparedStatement ps = con.prepareStatement("SELECT name FROM characters WHERE accountid = ?")) {
    ...
    public static class 地图代码 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!地图代码 - 目前地图").toString();
        }
    }
