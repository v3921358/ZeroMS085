...
public enum MapleJob {
    ...
    public static boolean is火毒魔导师(final int job) {
        return job / 10 == 21;
    }

    public static boolean is冰雷魔导师(final int job) {
        return job / 10 == 22;
    }
    ...
    public static boolean is暗影双刀(final int job) {
        return job / 10 == 43; // sub == 1 && job == 400
    }

    public static boolean is冲锋队长(final int job) {
        return job / 10 == 51;
    }

    public static boolean is船长(final int job) {
        return job / 10 == 52;
    }
    ...
    public static boolean is骑士团(final int job) {
        return job / 1000 == 1;
    }
    ...
    public static boolean is战士(final int job) {
    ...
    public static boolean is飞侠(final int job) {
