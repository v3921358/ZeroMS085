...
public class ServerConstants {
    ...
    // End of Poll
    public static final short MAPLE_VERSION = 85;//当前游戏的版本号 默认:85
    public static final String MAPLE_PATCH = "1";//当前游戏补丁的版本号 默认:1
    public static MapleType MAPLE_TYPE = MapleType.中国;//服务器标识 默认: 4 解释: 4 = 国服, 7 = 北美服, 8 = 美服, 9 = 韩服 5 = 测试服
    ...
    public static final int CHANNEL_COUNT = 10;//频道数量设置
    public static final String CashShop_Key = "a;!%dfb_=*-a123d9{P~";//现金商城密钥
    public static final String Login_Key = "pWv]xq:SPTCtk^LGnU9F";//登录服务器密钥
    public static int[] hot_sell = {10000007, 10000008, 10000009, 10000010, 10000011}; //修改人气道具
    ...
    public static boolean 调试输出封包 = Boolean.parseBoolean(ServerProperties.getProperty("ZeroMS.调试输出封包", "ture"));
    ...
    public static void loadSetting() {
        String[] x = ServerProperties.getProperty("ZeroMS.cashshop.HotSell", "10000007, 10000008, 10000009, 10000010, 10000011").split(",");
        int[] y = new int[x.length];
        for (int i = 0; i < x.length; i++) {
            y[i] = Integer.parseInt(x[i].replace(" ", ""));
        }
        hot_sell = y;
        TESPIA = ServerProperties.getProperty("ZeroMS.tespia", TESPIA);
        Use_Fixed_IV = ServerProperties.getProperty("ZeroMS.crypt", Use_Fixed_IV);
    }
