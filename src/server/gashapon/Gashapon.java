...
//                System.out.println(chance+" "+getId()+" "+itemid);
        ...
        World.Broadcast.broadcastGMMessage(MaplePacketCreator.serverNotice(6, "[GM 私聊系統] " + chr.getName() + "  更改物品:" + MapleItemInformationProvider.getInstance().getName(itemid) + " 几率更改为" + chance));
        FileoutputUtil.logToFile("logs/GM_LOG/GM更改飞天猪抽奖几率.txt", "\r\n" + FileoutputUtil.NowTime() + "GM: " + chr.getName() + "  更改物品:" + MapleItemInformationProvider.getInstance().getName(itemid) + " 几率更改为" + chance);
...
//                System.out.println(chance+" "+getId()+" "+itemid);
        ...
        World.Broadcast.broadcastGMMessage(MaplePacketCreator.serverNotice(6, "[GM 私聊系統] " + chr.getName() + "  更改物品:" + MapleItemInformationProvider.getInstance().getName(itemid) + " 数量更改为" + quantity));
...
//                System.out.println(chance+" "+getId()+" "+itemid);
        ...
        World.Broadcast.broadcastGMMessage(MaplePacketCreator.serverNotice(6, "[GM 私聊系統] " + chr.getName() + "  新增抽奖物品:" + MapleItemInformationProvider.getInstance().getName(itemid) + " 几率设定为" + chance + " 是否上绿喇叭:" + (msg ? "是" : "否") + " 数量更改为" + quantity));
        FileoutputUtil.logToFile("logs/GM_LOG/GM更改飞天猪抽奖几率.txt", "\r\n" + FileoutputUtil.NowTime() + "GM: " + chr.getName() + "  新增抽奖物品:" + MapleItemInformationProvider.getInstance().getName(itemid) + " 几率设定为" + chance + " 是否上绿色喇叭公告:" + (msg ? "是" : "否" + " 数量更改为" + quantity));
