...
//                    break;
                ...
                case 4331002:
                    statups.add(new Pair<>(MapleBuffStat.SHADOWPARTNERX, ret.x));
                    break;
                case 4331003:
                ...
                case 5221009: // Mind Control
                    ...
                    break;
                case 4341003: // Mind Control
                    monsterStatus.put(MonsterStatus.MONSTER_BOMB, (int) ret.damage);
                    break;
                case 23111002: //TODO LEGEND: damage increase?
                case 22161002: //phantom imprint
                    monsterStatus.put(MonsterStatus.IMPRINT, 1/*ret.x*/);
                    break;
                ...
                case 22141003: // Slow
                    ...
                    //statups.add(new Pair<>(MapleBuffStat.SLOW, ret.x));
                    statups.add(new Pair<>(MapleBuffStat.ELEMENT_RESET, ret.x));
                    break;
...
//    }
    ...
    private void applyBuffEffect(final MapleCharacter applyfrom, final MapleCharacter applyto, final boolean primary, final int newDuration, final boolean dc) {
        int localDuration = ServerConfig.无限BUFF ? 2100000000 : newDuration;
        ...
        switch (sourceid) {
            ...
            case 15101006: { // Soul Arrow
                ...
                final List<Pair<MapleBuffStat, Integer>> stat = Collections.singletonList(new Pair<>(MapleBuffStat.WK_CHARGE, 3));
                applyto.getMap().broadcastMessage(applyto, MaplePacketCreator.giveForeignBuff(applyto.getId(), stat, this), false);
                break;
            }
            ...
            case 4331002: {
                final List<Pair<MapleBuffStat, Integer>> stat = Collections.singletonList(new Pair<>(MapleBuffStat.SHADOWPARTNERX, 0));
                applyto.getMap().broadcastMessage(applyto, MaplePacketCreator.giveForeignBuff(applyto.getId(), stat, this), false);
                break;
            }
            case 15111006: { // Spark
