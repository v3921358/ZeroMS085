    ...
    public void applyEffect(MapleCharacter player, MapleMonster monster, boolean skill) {
        ...
        if (gui.ZeroMS_UI.ConfigValuesMap.get("怪物状态开关") <= 0) {
            ...
            case 143: // Weapon Reflect
                ...
                monster.getMap().broadcastMessage(MaplePacketCreator.yellowChat("[系統提示] 注意 " + monster.getStats().getName() + " 開啟了物理反射狀態。"));
                break;
            case 144: // Magic Reflect
                ...
                monster.getMap().broadcastMessage(MaplePacketCreator.yellowChat("[系統提示] 注意 " + monster.getStats().getName() + " 開啟了魔法反射狀態。"));
                break;
            case 145: // Weapon / Magic reflect
                ...
                monster.getMap().broadcastMessage(MaplePacketCreator.yellowChat("[系統提示] 注意 " + monster.getStats().getName() + " 開啟了物理和魔法反射狀態。"));
                break;
            case 200:
                if (monster == null) {
                    return;
