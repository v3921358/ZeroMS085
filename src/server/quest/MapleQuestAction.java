            ...
            case item: {
                ...
                for (QuestItem item : items) {
                    ...
                    if (count < 0) { // remove items
                        ...
                        if (qusetid == 8630) {
                            World.Broadcast.broadcastGMMessage(MaplePacketCreator.serverNotice(6, "[GM密語] 任務ID:" + qusetid + " 玩家:" + c.getName() + " 使用10張楓彩票兌換物品:" + name + "ID:" + id));
                            FileoutputUtil.logToFile("logs/Data/楓彩票兌換.txt", "\r\n 時間　[" + FileoutputUtil.NowTime() + "] IP: " + c.getClient().getSession().remoteAddress().toString().split(":")[0] + " 任務ID:" + qusetid + " 玩家:" + c.getName() + " 使用10張楓彩票兌換物品:" + name + "ID:" + id);
                        }
                        if (qusetid == 8631) {
                            World.Broadcast.broadcastGMMessage(MaplePacketCreator.serverNotice(6, "[GM密語] 任務ID:" + qusetid + " 玩家:" + c.getName() + " 使用50張楓彩票兌換物品:" + name + "ID:" + id));
                            FileoutputUtil.logToFile("logs/Data/楓彩票兌換.txt", "\r\n 時間　[" + FileoutputUtil.NowTime() + "] IP: " + c.getClient().getSession().remoteAddress().toString().split(":")[0] + " 任務ID:" + qusetid + " 玩家:" + c.getName() + " 使用50張楓彩票兌換物品:" + name + "ID:" + id);
                        }
                        if (qusetid == 8632) {
                            World.Broadcast.broadcastGMMessage(MaplePacketCreator.serverNotice(6, "[GM密語] 任務ID:" + qusetid + " 玩家:" + c.getName() + " 使用100張楓彩票兌換物品:" + name + "ID:" + id));
                            FileoutputUtil.logToFile("logs/Data/楓彩票兌換.txt", "\r\n 時間　[" + FileoutputUtil.NowTime() + "] IP: " + c.getClient().getSession().remoteAddress().toString().split(":")[0] + " 任務ID:" + qusetid + " 玩家:" + c.getName() + " 使用100張楓彩票兌換物品:" + name + "ID:" + id);
                        }
                        if (qusetid == 8633) {
                            World.Broadcast.broadcastGMMessage(MaplePacketCreator.serverNotice(6, "[GM密語] 任務ID:" + qusetid + " 玩家:" + c.getName() + " 使用200張楓彩票兌換物品:" + name + "ID:" + id));
                            FileoutputUtil.logToFile("logs/Data/楓彩票兌換.txt", "\r\n 時間　[" + FileoutputUtil.NowTime() + "] IP: " + c.getClient().getSession().remoteAddress().toString().split(":")[0] + " 任務ID:" + qusetid + " 玩家:" + c.getName() + " 使用200張楓彩票兌換物品:" + name + "ID:" + id);
                        }
                        if (qusetid == 8634) {
                            World.Broadcast.broadcastGMMessage(MaplePacketCreator.serverNotice(6, "[GM密語] 任務ID:" + qusetid + " 玩家:" + c.getName() + " 使用500張楓彩票兌換物品:" + name + "ID:" + id));
                            FileoutputUtil.logToFile("logs/Data/楓彩票兌換.txt", "\r\n 時間　[" + FileoutputUtil.NowTime() + "] IP: " + c.getClient().getSession().remoteAddress().toString().split(":")[0] + " 任務ID:" + qusetid + " 玩家:" + c.getName() + " 使用500張楓彩票兌換物品:" + name + "ID:" + id);
                        }
                        if (qusetid == 8635) {
                            World.Broadcast.broadcastGMMessage(MaplePacketCreator.serverNotice(6, "[GM密語] 任務ID:" + qusetid + " 玩家:" + c.getName() + " 使用1000張楓彩票兌換物品:" + name + "ID:" + id));
                            FileoutputUtil.logToFile("logs/Data/楓彩票兌換.txt", "\r\n 時間　[" + FileoutputUtil.NowTime() + "] IP: " + c.getClient().getSession().remoteAddress().toString().split(":")[0] + " 任務ID:" + qusetid + " 玩家:" + c.getName() + " 使用1000張楓彩票兌換物品:" + name + "ID:" + id);
                        }
                        if (qusetid == 8636) {
                            World.Broadcast.broadcastGMMessage(MaplePacketCreator.serverNotice(6, "[GM密語] 任務ID:" + qusetid + " 玩家:" + c.getName() + " 使用3000張楓彩票兌換物品:" + name + "ID:" + id));
                            FileoutputUtil.logToFile("logs/Data/楓彩票兌換.txt", "\r\n 時間　[" + FileoutputUtil.NowTime() + "] IP: " + c.getClient().getSession().remoteAddress().toString().split(":")[0] + " 任務ID:" + qusetid + " 玩家:" + c.getName() + " 使用3000張楓彩票兌換物品:" + name + "ID:" + id);
                        }
                        MapleInventoryManipulator.addById(c.getClient(), id, count, "", null, period);
                        c.getClient().getSession().writeAndFlush(MaplePacketCreator.getShowItemGain(id, count, true));
                    }
