...
public class MapleOxQuizFactory {
    ...
    public void initialize() {
        ...
        System.out.println("【信息】 游戏问答系统");
        try (Connection con = DatabaseConnection.getConnection(); PreparedStatement ps = con.prepareStatement("SELECT * FROM wz_oxdata"); ResultSet rs = ps.executeQuery()) {
            while (rs.next()) {
            ...
            FileoutputUtil.outError("logs/数据库.txt", e);
        }
