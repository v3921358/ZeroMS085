...
public class CharacterTransfer implements Externalizable {
    ...
    public int characterid, accountid, exp,
            ...
            familyid, seniorid, junior1, junior2, currentrep, totalrep, expression, constellation, blood, month, day, battleshipHP, gachexp, zdsh, LimitBreak,Czlj,Zsjf,maxlevel, vip, CsMod;
    ...
    public CharacterTransfer(final MapleCharacter chr) {
        ...
        this.zdsh = chr.getZdsh();
        this.LimitBreak = chr.getLimitBreak();
        this.Czlj = chr.getCzlj();
    //   this.Sfjf = chr.getSfjf();
        this.Zsjf = chr.getZsjf();
        this.maxlevel = chr.getMaxlevel();
    ...
    public void readExternal(final ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        this.zdsh = in.readInt();
        this.LimitBreak = in.readInt();
        this.Czlj = in.readInt();
       // this.Sfjf = in.readInt();
        this.Zsjf = in.readInt();
    ...
    public void writeExternal(final ObjectOutput out) throws IOException {
        ...
        out.writeInt(this.zdsh);
        out.writeInt(this.LimitBreak);
        out.writeInt(this.Czlj);
       // out.writeInt(this.Sfjf);
        out.writeInt(this.Zsjf);
