...
public class LoginServer {
    ...
    private static Map<Integer, Integer> AcctoChr = new HashMap<>();
    ...
    public static final void setup() {
        port = Short.parseShort(ServerProperties.getProperty("ZeroMS.login.port"));
   ...
   public static void setChrPos(Map<Integer, Pair<Integer, Integer>> keys) {
        chrpos = keys;
    }
    ...
    public static void setAcctoChrPos(Map<Integer,  Integer> keys) {
        AcctoChr = keys;
    }

    public static Map<Integer, Integer> getAcctoChrPos() {
        return AcctoChr;
    }

    public static void RemoveAcctoChrPos(int Accid) {
        AcctoChr.remove(Accid);
    }
}
