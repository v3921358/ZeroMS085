...
public class DBConPool {
    ...
    private void InitDBConPool() {
        ...
        dataSource.setUrl("jdbc:mysql://" + "127.0.0.1" + ":" + WorldConstants.dbport + "/" + WorldConstants.dbname + "?useUnicode=true&characterEncoding=GBK");
        dataSource.setUsername(WorldConstants.dbuser);
        dataSource.setPassword(WorldConstants.dbpassword);
