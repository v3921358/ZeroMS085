...
public class EventInstanceManager {
    ...
    private Map<String, String> eimlog = new HashMap<>();
    ...
    public final void setEimLog(final String key, final Integer value) {
        if (disposed) {
            return;
        }
        eimlog.put(key, ""+value);
    }

    public final void setEimLog(final String key, final String value) {
        if (disposed) {
            return;
        }
        eimlog.put(key, value);
    ...
    public final String getEimLog(final String key) {
        if (disposed) {
            return "";
        }
        return eimlog.get(key);
    }
