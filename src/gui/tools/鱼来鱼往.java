        ...
        if (result1 && result2  && result3) {
            try {
                ...
                if (rs.next()) {
                    ...
                    PreparedStatement Val3 = DatabaseConnection.getConnection().prepareStatement(sqlString2);
                    Val3.executeUpdate(sqlString2);

                    String sqlString3 = null;
                    sqlString3 = "update configvalues set Val = '" + 点券倍率.getText() + "' where id = 4013;";
                    PreparedStatement Val4 = DatabaseConnection.getConnection().prepareStatement(sqlString3);
