...
public class 椅子控制台 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel6.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 60, 270, 470));
        ...
        jPanel6.add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 60, 340, 470));
        ...
        jPanel6.add(jPanel37, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 60, 220, 470));
    ...
    private void 刷新泡澡浴桶() {
        浴桶间隔.setText("" + gui.ZeroMS_UI.ConfigValuesMap.get("浴桶椅子0") + "");
        浴桶经验1.setText("" + gui.ZeroMS_UI.ConfigValuesMap.get("浴桶椅子1") + "");
        浴桶经验2.setText("" + gui.ZeroMS_UI.ConfigValuesMap.get("浴桶椅子2") + "");
        浴桶经验3.setText("" + gui.ZeroMS_UI.ConfigValuesMap.get("浴桶椅子3") + "");
        浴桶经验4.setText("" + gui.ZeroMS_UI.ConfigValuesMap.get("浴桶椅子4") + "");
        浴桶经验5.setText("" + gui.ZeroMS_UI.ConfigValuesMap.get("浴桶椅子5") + "");
        浴桶经验6.setText("" + gui.ZeroMS_UI.ConfigValuesMap.get("浴桶椅子6") + "");
        浴桶经验7.setText("" + gui.ZeroMS_UI.ConfigValuesMap.get("浴桶椅子7") + "");
        浴桶经验8.setText("" + gui.ZeroMS_UI.ConfigValuesMap.get("浴桶椅子8") + "");
        浴桶经验9.setText("" + gui.ZeroMS_UI.ConfigValuesMap.get("浴桶椅子9") + "");
    }

    private void 刷新财神椅子() {
        财神椅子金币上限.setText("" + gui.ZeroMS_UI.ConfigValuesMap.get("财神椅子1") + "");
        财神椅子间隔.setText("" + gui.ZeroMS_UI.ConfigValuesMap.get("财神椅子2") + "");
        财神椅子叠加.setText("" + gui.ZeroMS_UI.ConfigValuesMap.get("财神椅子3") + "");
    }
    ...
    private void 刷新枫叶椅子() {
        枫叶纪念凳金币.setText("" + gui.ZeroMS_UI.ConfigValuesMap.get("枫叶纪念凳金币") + "");
        枫叶纪念凳经验.setText("" + gui.ZeroMS_UI.ConfigValuesMap.get("枫叶纪念凳经验") + "");
        枫叶纪念凳人数.setText("" + gui.ZeroMS_UI.ConfigValuesMap.get("枫叶纪念凳人数") + "");
        枫叶纪念凳间隔.setText("" + gui.ZeroMS_UI.ConfigValuesMap.get("枫叶纪念凳间隔") + "");
    }
