...
public class MapleAESOFB {
 ...
 (byte) 0x33, 0x00, 0x00, 0x00, 
    ...
    //private final static SecretKeySpec skey = new SecretKeySpec(new byte[]{0x14, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, (byte) 0xB4, 0x00, 0x00, 0x00, 0x1B, 0x00, 0x00, 0x00, 0x0F, 0x00, 0x00, 0x00, 0x33, 0x00, 0x00, 0x00, 0x52, 0x00, 0x00, 0x00}, "AES");
// KMS
//    {0x13, 0x00, 0x00, 0x00, 0x52, 0x00, 0x00, 0x00, 0x2A, 0x00, 0x00, 0x00, 0x5B, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x60, 0x00, 0x00, 0x00}
    ...
    public byte[] crypt(byte[] data) {
        ...
        //int llength = ServerConfig.TESPIA ? 0x5C0 : 0x5B0;
        int llength = 0x5B0;
        int start = 0;
        ...
        try {
            while (remaining > 0) {
                ...
                start += llength;
                remaining -= llength;
                //llength = ServerConfig.TESPIA ? 0x5C4 : 0x5B4;
                llength = 0x5B4;
            }
            updateIv();
